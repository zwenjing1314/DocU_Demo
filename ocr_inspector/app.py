...
def _write_job_manifest(
    ...
    manifest = {
        ...
        "artifacts": {  # 输出产物 URLs
            ...
            "document_ai_copilot_json": job.output_url(job.document_ai_copilot_json_path),
            "document_ai_copilot_markdown": job.output_url(job.document_ai_copilot_markdown_path),
...
def _build_response_payload(
    ...
    return {
        ...
        "analysis": {
            ...
            "copilot_status": ocr_result.get("document_ai_copilot_result", {}).get("status", "unknown"),
            "copilot_stage_count": ocr_result.get("document_ai_copilot_result", {}).get("readiness", {}).get("stage_count", 0),
            "copilot_demo_ready": ocr_result.get("document_ai_copilot_result", {}).get("readiness", {}).get("demo_ready", False),
        ...
        "document_ai_copilot": ocr_result.get("document_ai_copilot_result", {}),
